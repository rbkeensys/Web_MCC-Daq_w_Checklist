...
const FAULT_MSGS = {
  evapLevelErr: 'Evaporator Level Error\n\n'
    + 'The evaporator did not show a wet level after priming.\n'
    + 'Possible level-sensor (AI:EvapLevel) or feed peristaltic-pump failure.\n\n'
    + 'Check and try again.'
};
