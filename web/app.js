    ...
    window._launchViewer = async function (local) {
      try{
        ...
        if (local) {
          ...
          console.log('[Viewer] invoked mccviewer: handler -- if nothing opens, run tools/register_viewer_protocol.bat once on this computer');
        }
