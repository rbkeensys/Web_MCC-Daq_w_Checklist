...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      P([new TextRun("The CTR0 count is read once and exposed as the cumulative total: AI:CondTotal = count/K (rollover-safe 32-bit, summed into a big-int). There is NO second channel -- the flow RATE is derived from the total in the expression, windowed over "), code("condRateWin"), new TextRun(" (so per-tick pulse coarseness averages out), held between updates:")]),
