...
const safety = [
 ...
 ["feedStallRpm / feedStallMaxML","200 / 1500","rpm / ml","FEED-STALL guard: this much feed dead-reckoned at fill-rate commands without one UPWARD sender step -> the pump is not delivering (empty supply/tubing/stepper) or the sender is stuck -> latches evapLevelErr (trip + popup). Rig 7/14: 300rpm for 15min, ~4L commanded, level frozen, vessel slowly pressurizing."],
