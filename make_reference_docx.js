...
const safety = [
 ...
 ["feedSlewRpmS","10","rpm/s","AUTO-FEED SLEW LIMIT: production-measure jumps slammed the feed 0..450rpm, and every slam is a cold-water rush the makeup PI then chases (the 42s eT limit cycle). The level loop is slow anyway -- the command is rate-limited."],
