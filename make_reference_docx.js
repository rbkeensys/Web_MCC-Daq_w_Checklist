...
const safety = [
 ...
 ["evapHighMark / evapHighWarnS","2750 / 3","ml / s","HIGH-LEVEL WARNING (2600|2900 plateau edge; E-TC DIN float ORed in): latched UI popup after 3s persistence (float bob flicks single samples onto the 2900 plateau from ~2650 true) + FeedFollow cuts the feed INSTANTLY on yEvapHigh. Not during PURGE; not a hard trip."],
...
const startup = [
 ...
 ["fillStopML","200","ml","HEAT fills COLD water to evapMidMark - this: the charge expands ~4% to boiling and the slew-limited decel keeps delivering, so filling to the mark itself overshot into the high warn every startup. Expansion + RUN's capped-P close the gap; HEAT->RUN advances on temp + raw >= mark-fillStopML."],
