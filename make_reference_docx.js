...
const safety = [
 ...
 ["vaporOutSoft","120","C","Blower VAPOR-OUT FOLD-BACK: above this discharge temp, ALL blower raises pause (integral/seek/lift) and the target actively backs off -- the blower is heating the vapor, not pumping it (rig 7/15: vO rode 110-138 against the 140 trip while nothing condensed and every other gate read green)."],
