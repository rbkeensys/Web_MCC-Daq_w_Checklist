...
const ctrl = [
 ...
 ["prodFastWinS / prodFastAvgS","60 / 180","s / s","FAST production estimate (prodFast) for the FEED feed-forward: 60s totalizer windows into a 180s EMA (~2-3min response vs prodMeas ~10min). RUN + proven meter only; cleared outside RUN. The BLOWER keeps the slow stable prodMeas -- two consumers, two time constants."],
