...
const safety = [
 ...
 ["superHtrRegC / kpShElem","250 / 0.05","C / duty/C","SH ELEMENT-TEMP REGULATION: duty capped so the cartridge holds ~200C until real vapor flow carries the heat away (poor coupling into thin vapor); then the superheat PI takes over. Full duty 20C below target."],
