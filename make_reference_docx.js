...
const startup = [
 ...
 ["evapLevelSet / kFeedLevelI / feedFillLpm","2000 / 0.0015 / 0.25","ml / (L/min/s) / L/min","Operating level = EvapMid. Hold integral gain (toggle speed) / warm-up fill rate. Feed = production feed-forward + the level integral; meter bias can't run the level away (wet always draws feed below boil-off)."],
