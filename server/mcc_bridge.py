...
class MCCBridge:
    ...
    def open(self, cfg: AppConfig):
        ...
        # RE-OPEN SAFETY (uldaq): open() can be called again on a bridge that
        # already holds live connections (acq-loop restart). uldaq handles do
